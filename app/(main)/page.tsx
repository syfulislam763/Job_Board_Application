...
export default function HeroSection() {
  ...
  return (
    <main>
      ...
      <section className="relative w-full bg-[#f8f8fd] overflow-hidden min-h-85 md:min-h-150">
        ...
        <div className="relative z-20 mx-auto max-w-full md:max-w-[90%] px-6 py-10 md:py-14 md:mt-20">
          <div className="w-full md:w-[70%]">
            ...
            <AnimateIn variant="fadeUp" duration={700} delay={0}>
            ...
            <AnimateIn variant="fadeLeft" duration={600} delay={200}>
            ...
            <AnimateIn variant="fadeUp" duration={600} delay={300}>
            ...
            <AnimateIn variant="fadeUp" duration={600} delay={420}>
            ...
            <AnimateIn variant="fadeUp" duration={500} delay={550}>
      ...
      <AnimateIn variant="fadeUp" duration={600}>
        <Footer onNavigate={() => {}} />
      </AnimateIn>
